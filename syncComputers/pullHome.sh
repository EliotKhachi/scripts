...
git -C /home/eliot/Public/repos/scripts pull origin
...
xargs -a <(awk '! /^ *(#|$)/' "snap.txt") -r -- sudo snap install ## installs packages from snap.txt, ignoring comments and empty lines
